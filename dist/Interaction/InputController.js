 ...
 * @private
 */
export const _checkGroupObject = {
    groups: {},
    values: {}
};
/**
 ...
 */
export function registrer(item, tabIndex, tabGroup) {
 ...
 */
export function registrerCheckGroup(cb) {
 ...
 * @param cb CheckBox
 */
export function unRegistrerCheckGroup(cb) {
...
/** 更新分组中选中的checkbox组件  */
export function updateCheckGroupSelected(cb) {
    if (cb.checkGroup) {
...
/** 获取分组中选中的checkbox值 */
export function getCheckGroupSelectedValue(name) {
...
/** 设置选中 */
export function setCheckGroupSelectedValue(name, uuid) {
