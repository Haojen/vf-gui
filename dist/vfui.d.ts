...
declare module 'c/Tween/core' {
	import Tween from 'c/Tween/Tween';
	/**
	 * 插件存储器
...
declare module 'c/Tween/index' {
	...
	import Easing from 'c/Tween/Easing';
...
declare module 'c/Text/TextStyle' {
...
declare module 'Enum/FontStyleEnum' {
	/**
	 * 文字样式
	 * @since 1.0.0
	 */
	export const enum FontStyleEnum {
	    /** 粗体 */
	    bold = "bold",
	    /** 斜体 */
	    italic = "italic",
...
declare module 'Interaction/KeyboardEvent' {
	import { UIBase } from 'UI'; class KeyboardSelectEvent {
	    /**
	     * document的键盘事件
	    */
	    constructor();
...
declare module 'c/Tween/Timeline' {
	import Tween from 'c/Tween/Tween';
	/**
	 * 将序列的所有元素随机排序。
	 * @param a 序列数组
