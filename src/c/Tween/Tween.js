...
class Tween {
   ...
   * @static
   */
  static to (node, object, to, params) {
    return Tween.fromTo(node, object, to, params)
  }
  /**
   ...
   * @static
   */
  static from (node, object, from, params) {
    return Tween.fromTo(node, object, from, params)
  }
